...
BLOCKLIST_OPTIX_OSL = [
    ...
    'bump_with_displacement.blend',
    'ray_portal.blend',
    # The Volumetric noise texture uses a different default texture mapping in OptiX OSL. See 129279
    ...
    # denoise_specular makes use of the `Window` texture coordinate which is incorrect. See 108372
    'denoise_specular.blend',
