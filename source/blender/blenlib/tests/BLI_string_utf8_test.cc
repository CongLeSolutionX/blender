...
/* -------------------------------------------------------------------- */
/** \name Test #BLI_strncpy_trunc_utf8
 * \{ */

TEST(string, StrNCopyTruncateUtf8)
{

#define EXPECT_STR_UTF8_TRUNC(src, dst_expect, dst_maxncpy) \
  { \
    char dst[dst_maxncpy]; \
    size_t len = BLI_strncpy_trunc_utf8_rlen(dst, src, dst_maxncpy); \
    EXPECT_EQ(len, strlen(dst)); \
    EXPECT_STREQ(dst, dst_expect); \
  }

  /* Single characters. */
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_1, STR_MB_ALPHA_1, 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_1, "", 1);

  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_2, STR_MB_ALPHA_2, 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_2, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_2, "", 1);

  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3, STR_MB_ALPHA_3, 4);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3, "", 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3, "", 1);

  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4, STR_MB_ALPHA_4, 5);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4, "", 4);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4, "", 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4, "", 1);

  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5, STR_MB_ALPHA_5, 6);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5, "", 5);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5, "", 4);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5, "", 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5, "", 1);

  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6, STR_MB_ALPHA_6, 7);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6, "", 6);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6, "", 5);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6, "", 4);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6, "", 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6, "", 1);

  /* Multiple characters. */
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_2 STR_MB_ALPHA_2, STR_MB_ALPHA_2 STR_MB_ALPHA_2, 5);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_2 STR_MB_ALPHA_2, STR_MB_ALPHA_2, 4);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_2 STR_MB_ALPHA_2, STR_MB_ALPHA_2, 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_2, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_2, "", 1);

  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3 STR_MB_ALPHA_3, STR_MB_ALPHA_3 STR_MB_ALPHA_3, 7);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3 STR_MB_ALPHA_3, STR_MB_ALPHA_3, 6);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3 STR_MB_ALPHA_3, STR_MB_ALPHA_3, 5);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3 STR_MB_ALPHA_3, STR_MB_ALPHA_3, 4);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3 STR_MB_ALPHA_3, "", 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3 STR_MB_ALPHA_3, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_3 STR_MB_ALPHA_3, "", 1);

  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4 STR_MB_ALPHA_4, STR_MB_ALPHA_4 STR_MB_ALPHA_4, 9);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4 STR_MB_ALPHA_4, STR_MB_ALPHA_4, 8);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4 STR_MB_ALPHA_4, STR_MB_ALPHA_4, 7);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4 STR_MB_ALPHA_4, STR_MB_ALPHA_4, 6);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4 STR_MB_ALPHA_4, STR_MB_ALPHA_4, 5);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4 STR_MB_ALPHA_4, "", 4);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4 STR_MB_ALPHA_4, "", 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4 STR_MB_ALPHA_4, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_4 STR_MB_ALPHA_4, "", 1);

  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, STR_MB_ALPHA_5 STR_MB_ALPHA_5, 11);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, STR_MB_ALPHA_5, 10);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, STR_MB_ALPHA_5, 9);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, STR_MB_ALPHA_5, 8);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, STR_MB_ALPHA_5, 7);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, STR_MB_ALPHA_5, 6);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, "", 5);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, "", 4);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, "", 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_5 STR_MB_ALPHA_5, "", 1);

  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, STR_MB_ALPHA_6 STR_MB_ALPHA_6, 13);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, STR_MB_ALPHA_6, 12);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, STR_MB_ALPHA_6, 11);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, STR_MB_ALPHA_6, 10);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, STR_MB_ALPHA_6, 9);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, STR_MB_ALPHA_6, 8);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, STR_MB_ALPHA_6, 7);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, "", 6);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, "", 5);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, "", 4);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, "", 3);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, "", 2);
  EXPECT_STR_UTF8_TRUNC(STR_MB_ALPHA_6 STR_MB_ALPHA_6, "", 1);
}
