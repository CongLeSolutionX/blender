...
static void extract_face_corner_dots_mesh(const MeshRenderData &mr, gpu::IndexBuf &face_dots)
{
...
static void extract_face_corner_dots_bm(const MeshRenderData &mr, gpu::IndexBuf &face_dots)
{
  BMesh &bm = *mr.bm;
  IndexMaskMemory memory;
...
void extract_face_corner_dots(const MeshRenderData &mr, gpu::IndexBuf &face_dots)
{
  if (mr.extract_type == MeshExtractType::Mesh) {
    extract_face_corner_dots_mesh(mr, face_dots);
  }
  else {
    extract_face_corner_dots_bm(mr, face_dots);
  }
}
