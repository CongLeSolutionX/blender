...
static PointerRNA rna_Depsgraph_ids_get(CollectionPropertyIterator *iter)
{
  ...
  return RNA_id_pointer_create(reinterpret_cast<ID *>(id));
}
...
static PointerRNA rna_Depsgraph_scene_get(PointerRNA *ptr)
{
  ...
  PointerRNA newptr = RNA_pointer_create_isolated(&scene->id, &RNA_Scene, scene);
  return newptr;
}
...
static PointerRNA rna_Depsgraph_view_layer_get(PointerRNA *ptr)
{
  ...
  PointerRNA newptr = RNA_pointer_create_isolated(&scene->id, &RNA_ViewLayer, view_layer);
  return newptr;
}
...
static PointerRNA rna_Depsgraph_scene_eval_get(PointerRNA *ptr)
{
  ...
  PointerRNA newptr = RNA_pointer_create_isolated(&scene_eval->id, &RNA_Scene, scene_eval);
  return newptr;
}
