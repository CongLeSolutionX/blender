    ...
    ID *id, ReportList *reports, const char *name, const int type, const int domain)
{
  ...
  PointerRNA ptr = RNA_pointer_create_isolated(id, &RNA_Attribute, layer);
  return ptr;
}
...
static PointerRNA rna_AttributeGroupID_active_get(PointerRNA *ptr)
{
  ...
  PointerRNA attribute_ptr = RNA_pointer_create_isolated(ptr->owner_id, &RNA_Attribute, layer);
                                                            ...
                                                            const int domain)
{
  ...
  PointerRNA ptr = RNA_pointer_create_isolated(grease_pencil_id, &RNA_Attribute, layer);
  return ptr;
}
