...
static bool panel_poll(const bContext *C, PanelType *pt)
{
  ...
  PointerRNA ptr = RNA_pointer_create_isolated(nullptr, pt->rna_ext.srna, nullptr); /* dummy */
                                     ...
                                     StructFreeFunc free)
{
  ...
  PointerRNA dummy_panel_ptr = RNA_pointer_create_isolated(nullptr, &RNA_Panel, &dummy_panel);
                             ...
                             int flt_flag)
{
  ...
  PointerRNA ul_ptr = RNA_pointer_create_isolated(
                                      ...
                                      StructFreeFunc free)
{
  ...
  PointerRNA dummy_ul_ptr = RNA_pointer_create_isolated(nullptr, &RNA_UIList, &dummy_uilist);
...
static void header_draw(const bContext *C, Header *hdr)
{
  ...
  PointerRNA htr = RNA_pointer_create_isolated(
                                      ...
                                      StructFreeFunc free)
{
  ...
  PointerRNA dummy_header_ptr = RNA_pointer_create_isolated(nullptr, &RNA_Header, &dummy_header);
...
static void menu_draw(const bContext *C, Menu *menu)
{
  ...
  PointerRNA mtr = RNA_pointer_create_isolated(
                                    ...
                                    StructFreeFunc free)
{
  ...
  PointerRNA dummy_menu_ptr = RNA_pointer_create_isolated(nullptr, &RNA_Menu, &dummy_menu);
                                          ...
                                          StructFreeFunc free)
{
  ...
  PointerRNA dummy_shelf_ptr = RNA_pointer_create_isolated(nullptr, &RNA_AssetShelf, &dummy_shelf);
                                           ...
                                           StructFreeFunc free)
{
  ...
  PointerRNA dummy_file_handler_ptr = RNA_pointer_create_isolated(
