...
static void rna_gizmo_draw_cb(const bContext *C, wmGizmo *gz)
{
  ...
  ParameterList list;
  FunctionRNA *func;
  PointerRNA gz_ptr = RNA_pointer_create_isolated(nullptr, gz->type->rna_ext.srna, gz);
                                     ...
                                     StructFreeFunc free)
{
  ...
  PointerRNA dummy_gizmo_ptr = RNA_pointer_create_isolated(nullptr, &RNA_Gizmo, &dummy_gizmo);
...
static bool rna_gizmogroup_poll_cb(const bContext *C, wmGizmoGroupType *gzgt)
{
  ...
  PointerRNA ptr = RNA_pointer_create_isolated(nullptr, gzgt->rna_ext.srna, nullptr); /* dummy */
...
static void rna_gizmogroup_setup_cb(const bContext *C, wmGizmoGroup *gzgroup)
{
  ...
  PointerRNA gzgroup_ptr = RNA_pointer_create_isolated(
                                          ...
                                          StructFreeFunc free)
{
  ...
  PointerRNA wgptr = RNA_pointer_create_isolated(nullptr, &RNA_GizmoGroup, &dummy_gizmo_group);
