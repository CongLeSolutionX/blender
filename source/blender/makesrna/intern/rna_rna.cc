...
{
  return RNA_pointer_create_isolated(nullptr, &RNA_Struct, ((StructRNA *)ptr->data)->base);
}

static PointerRNA rna_Struct_nested_get(PointerRNA *ptr)
{
  return RNA_pointer_create_isolated(nullptr, &RNA_Struct, ((StructRNA *)ptr->data)->nested);
}

static PointerRNA rna_Struct_name_property_get(PointerRNA *ptr)
{
  return RNA_pointer_create_isolated(
...
static PointerRNA rna_Struct_properties_get(CollectionPropertyIterator *iter)
{
  ...
  return RNA_pointer_create_isolated(nullptr, &RNA_Property, internal->link);
}
...
static PointerRNA rna_Struct_functions_get(CollectionPropertyIterator *iter)
{
  ...
  /* we return either PropertyRNA* or IDProperty*, the rna_access.cc
   * functions can handle both as PropertyRNA* with some tricks */
  return RNA_pointer_create_isolated(nullptr, &RNA_Function, internal->link);
}
...
{
  return RNA_pointer_create_isolated(nullptr, &RNA_Struct, ptr->type);
}
...
static PointerRNA rna_Property_srna_get(PointerRNA *ptr)
{
  ...
  return RNA_pointer_create_isolated(nullptr, &RNA_Struct, prop->srna);
}
...
static PointerRNA rna_PointerProperty_fixed_type_get(PointerRNA *ptr)
{
  PropertyRNA *prop = (PropertyRNA *)ptr->data;
  prop = rna_ensure_property(prop);
  return RNA_pointer_create_isolated(nullptr, &RNA_Struct, ((PointerPropertyRNA *)prop)->type);
}
...
static bool rna_BlenderRNA_structs_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
  ...
  if (srna != nullptr) {
    *r_ptr = RNA_pointer_create_isolated(nullptr, &RNA_Struct, srna);
    return true;
  }
  else {
    return false;
