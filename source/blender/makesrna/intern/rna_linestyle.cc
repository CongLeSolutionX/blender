...
static void rna_def_linestyle_mtex(BlenderRNA *brna)
{
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "mapto", MAP_COL);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "mapto", MAP_ALPHA);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "alphafac");
  ...
  RNA_def_property_float_sdna(prop, nullptr, "colfac");
                                         ...
                                         const bool color)
{
  ...
  RNA_def_property_enum_sdna(prop, nullptr, "modifier.type");
  ...
  if (blend) {
    ...
    RNA_def_property_enum_sdna(prop, nullptr, "modifier.blend");
    ...
    RNA_def_property_float_sdna(prop, nullptr, "modifier.influence");
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "modifier.flags", LS_MODIFIER_ENABLED);
  RNA_def_property_ui_text(prop, "Use", "Enable or disable this modifier during stroke rendering");
  RNA_def_property_update(prop, NC_LINESTYLE, "rna_LineStyle_update");

  prop = RNA_def_property(srna, "expanded", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "modifier.flags", LS_MODIFIER_EXPANDED);
...
static void rna_def_modifier_color_ramp_common(StructRNA *srna, int range)
{
  ...
  RNA_def_property_pointer_sdna(prop, nullptr, "color_ramp");
...
static void rna_def_modifier_curve_common(StructRNA *srna, bool range, bool value)
{
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flags", LS_MODIFIER_INVERT);
  ...
  if (value) {
    ...
    RNA_def_property_float_sdna(prop, nullptr, "value_min");
    ...
    RNA_def_property_float_sdna(prop, nullptr, "value_max");
...
static void rna_def_modifier_material_common(StructRNA *srna)
{
  ...
  RNA_def_property_enum_sdna(prop, nullptr, "mat_attr");
...
static void rna_def_linestyle_modifiers(BlenderRNA *brna)
{
  ...
  srna = RNA_def_struct(brna, "LineStyleModifier", nullptr);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flags", LS_MODIFIER_USE_RAMP);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "min_angle");
  ...
  RNA_def_property_float_sdna(prop, nullptr, "max_angle");
  ...
  RNA_def_property_float_sdna(prop, nullptr, "min_curvature");
  ...
  RNA_def_property_float_sdna(prop, nullptr, "max_curvature");
  ...
  RNA_def_property_float_sdna(prop, nullptr, "min_thickness");
  RNA_def_property_range(prop, 0.0f, 10000.0f);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "max_thickness");
  RNA_def_property_range(prop, 0.0f, 10000.0f);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "orientation");
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flags", LS_THICKNESS_ASYMMETRIC);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "sampling");
  RNA_def_property_range(prop, 0.0f, 10000.0f);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_float_sdna(prop, nullptr, "wavelength");
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flags", LS_MODIFIER_SPATIAL_NOISE_PURERANDOM);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_float_sdna(prop, nullptr, "backbone_length");
  ...
  RNA_def_property_float_sdna(prop, nullptr, "tip_length");
  ...
  RNA_def_property_int_sdna(prop, nullptr, "rounds");
  ...
  RNA_def_property_int_sdna(prop, nullptr, "random_radius");
  ...
  RNA_def_property_int_sdna(prop, nullptr, "random_center");
  ...
  RNA_def_property_int_sdna(prop, nullptr, "random_backbone");
  ...
  RNA_def_property_enum_sdna(prop, nullptr, "pivot");
  ...
  RNA_def_property_float_sdna(prop, nullptr, "pivot_u");
  RNA_def_property_range(prop, 0.0f, 1.0f);
  RNA_def_property_ui_text(prop,
  ...
  RNA_def_property_float_sdna(prop, nullptr, "pivot_x");
  ...
  RNA_def_property_float_sdna(prop, nullptr, "pivot_y");
...
static void rna_def_freestyle_color_modifiers(BlenderRNA *brna, PropertyRNA *cprop)
{
  ...
  srna = RNA_def_struct(brna, "LineStyleColorModifiers", nullptr);
...
static void rna_def_freestyle_alpha_modifiers(BlenderRNA *brna, PropertyRNA *cprop)
{
  ...
  srna = RNA_def_struct(brna, "LineStyleAlphaModifiers", nullptr);
  RNA_def_struct_sdna(srna, "FreestyleLineStyle");
...
static void rna_def_freestyle_thickness_modifiers(BlenderRNA *brna, PropertyRNA *cprop)
{
  ...
  srna = RNA_def_struct(brna, "LineStyleThicknessModifiers", nullptr);
  RNA_def_struct_sdna(srna, "FreestyleLineStyle");
  RNA_def_struct_ui_text(
...
static void rna_def_freestyle_geometry_modifiers(BlenderRNA *brna, PropertyRNA *cprop)
{
  ...
  srna = RNA_def_struct(brna, "LineStyleGeometryModifiers", nullptr);
  RNA_def_struct_sdna(srna, "FreestyleLineStyle");
  RNA_def_struct_ui_text(
...
#  endif
  ...
  RNA_def_property_enum_bitflag_sdna(prop, nullptr, "panel");
  ...
  RNA_def_property_enum_bitflag_sdna(prop, nullptr, "thickness_position");
  ...
  RNA_def_property_float_sdna(prop, nullptr, "thickness_ratio");
  RNA_def_property_range(prop, 0.0f, 1.0f);
  RNA_def_property_ui_text(
      prop,
      "Thickness Ratio",
  ...
  RNA_def_property_collection_sdna(prop, nullptr, "color_modifiers", nullptr);
  ...
  RNA_def_property_collection_sdna(prop, nullptr, "alpha_modifiers", nullptr);
  ...
  RNA_def_property_collection_sdna(prop, nullptr, "thickness_modifiers", nullptr);
  ...
  RNA_def_property_collection_sdna(prop, nullptr, "geometry_modifiers", nullptr);
  ...
  RNA_def_property_boolean_negative_sdna(prop, nullptr, "flag", LS_NO_CHAINING);
  ...
  RNA_def_property_enum_sdna(prop, nullptr, "chaining");
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_SAME_OBJECT);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_SPLIT_LENGTH);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_float_sdna(prop, nullptr, "split_length");
  RNA_def_property_range(prop, 0.0f, 10000.0f);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_MIN_2D_ANGLE);
  RNA_def_property_ui_text(prop,
                           "Use Min 2D Angle",
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_MAX_2D_ANGLE);
  RNA_def_property_ui_text(prop,
                           "Use Max 2D Angle",
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_MIN_2D_LENGTH);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_float_sdna(prop, nullptr, "min_length");
  RNA_def_property_range(prop, 0.0f, 10000.0f);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_MAX_2D_LENGTH);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_float_sdna(prop, nullptr, "max_length");
  RNA_def_property_range(prop, 0.0f, 10000.0f);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_CHAIN_COUNT);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "chain_count");
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_SPLIT_PATTERN);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_int_sdna(prop, nullptr, "split_dash1");
  ...
  RNA_def_property_int_sdna(prop, nullptr, "split_gap1");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "split_dash2");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "split_gap2");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "split_dash3");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "split_gap3");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_MATERIAL_BOUNDARY);
  RNA_def_property_ui_text(prop,
                           "Material Boundary",
  ...
  RNA_def_property_boolean_negative_sdna(prop, nullptr, "flag", LS_NO_SORTING);
  ...
  RNA_def_property_enum_sdna(prop, nullptr, "sort_key");
  ...
  RNA_def_property_enum_sdna(prop, nullptr, "integration_type");
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_DASHED_LINE);
  ...
  RNA_def_property_enum_bitflag_sdna(prop, nullptr, "caps");
  ...
  RNA_def_property_int_sdna(prop, nullptr, "dash1");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "gap1");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "dash2");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "gap2");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "dash3");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  ...
  RNA_def_property_int_sdna(prop, nullptr, "gap3");
  RNA_def_property_range(prop, 0, USHRT_MAX);
  RNA_def_property_ui_text(prop, "Gap 3", "Length of the 3rd gap for dashed lines");
  RNA_def_property_update(prop, NC_LINESTYLE, "rna_LineStyle_update");

  prop = RNA_def_property(srna, "use_texture", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", LS_TEXTURE);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "texstep");
