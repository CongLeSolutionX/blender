...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_PreferencesView, ptr->data);
}

static PointerRNA rna_UserDef_edit_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_PreferencesEdit, ptr->data);
}

static PointerRNA rna_UserDef_input_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_PreferencesInput, ptr->data);
}

static PointerRNA rna_UserDef_keymap_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_PreferencesKeymap, ptr->data);
}

static PointerRNA rna_UserDef_filepaths_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_PreferencesFilePaths, ptr->data);
}

static PointerRNA rna_UserDef_extensions_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_PreferencesExtensions, ptr->data);
}

static PointerRNA rna_UserDef_system_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_PreferencesSystem, ptr->data);
}

static PointerRNA rna_UserDef_apps_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_PreferencesApps, ptr->data);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_ThemeSpaceGeneric, ptr->data);
}

static PointerRNA rna_Theme_gradient_colors_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_ThemeGradientColors, ptr->data);
}

static PointerRNA rna_Theme_space_gradient_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_ThemeSpaceGradient, ptr->data);
}

static PointerRNA rna_Theme_space_list_generic_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_ThemeSpaceListGeneric, ptr->data);
}
...
static PointerRNA rna_Addon_preferences_get(PointerRNA *ptr)
{
  ...
  if (apt) {
    ...
    return RNA_pointer_create_with_ancestors(*ptr, apt->rna_ext.srna, addon->prop);
  }
  else {
                                         ...
                                         StructFreeFunc free)
{
  ...
  PointerRNA dummy_addon_ptr = RNA_pointer_create_isolated(
