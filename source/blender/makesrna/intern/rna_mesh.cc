...
bool rna_Mesh_loop_triangles_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
  ...
  rna_pointer_inherit_refine(*ptr,
...
bool rna_Mesh_edges_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
  ...
  blender::int2 *edges = static_cast<blender::int2 *>(CustomData_get_layer_named_for_write(
      &mesh->edge_data, CD_PROP_INT32_2D, ".edge_verts", mesh->edges_num));
  rna_pointer_inherit_refine(*ptr, &RNA_MeshEdge, &edges[index], *r_ptr);
  return true;
}
...
bool rna_Mesh_loops_lookup_int(PointerRNA *ptr, int index, PointerRNA *r_ptr)
{
  ...
  rna_pointer_inherit_refine(*ptr, &RNA_MeshLoop, &mesh->corner_verts_for_write()[index], *r_ptr);
  return true;
}
                                            ...
                                            const bool do_init)
{
  ...
  PointerRNA ptr = RNA_pointer_create_isolated(&mesh->id, &RNA_MeshLoopColorLayer, cdl);
  return ptr;
}
                                         ...
                                         const bool do_init)
{
  ...
  PointerRNA ptr = RNA_pointer_create_isolated(&mesh->id, &RNA_MeshUVLoopLayer, cdl);
  return ptr;
}
