...
static void wm_gesture_draw_line_active_side(const rcti *rect, const bool flip)
{
  ...
  uint shdr_pos = GPU_vertformat_attr_add(format, "pos", VertAttrType::F32, 2, GPU_FETCH_FLOAT);
  uint shdr_col = GPU_vertformat_attr_add(format, "color", VertAttrType::F32, 4, GPU_FETCH_FLOAT);
