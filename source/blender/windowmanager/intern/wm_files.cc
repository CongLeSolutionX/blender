...
{
  PointerRNA ptr_a = RNA_pointer_create_isolated(nullptr, &RNA_Preferences, userdef_prev);
  PointerRNA ptr_b = RNA_pointer_create_isolated(nullptr, &RNA_Preferences, userdef_curr);
...
static uiBlock *block_create_autorun_warning(bContext *C, ARegion *region, void * /*arg1*/)
{
  ...
  PointerRNA pref_ptr = RNA_pointer_create_isolated(nullptr, &RNA_PreferencesFilePaths, &U);
  uiItemR(layout,
          &pref_ptr,
