...
void WM_operator_properties_create_ptr(PointerRNA *ptr, wmOperatorType *ot)
{
  ...
  *ptr = RNA_pointer_create_isolated(static_cast<ID *>(G_MAIN->wm.first), ot->srna, nullptr);
}
...
void WM_operator_properties_create(PointerRNA *ptr, const char *opstring)
{
  ...
  if (ot) {
    ...
    /* Set the ID so the context can be accessed: see #STRUCT_NO_CONTEXT_WITHOUT_OWNER_ID. */
    *ptr = RNA_pointer_create_isolated(
...
void WM_operator_last_properties_ensure(wmOperatorType *ot, PointerRNA *ptr)
{
  ...
  *ptr = RNA_pointer_create_isolated(static_cast<ID *>(G_MAIN->wm.first), ot->srna, props);
}
...
static int radial_control_get_properties(bContext *C, wmOperator *op)
{
  ...
  PointerRNA ctx_ptr = RNA_pointer_create_isolated(nullptr, &RNA_Context, C);
