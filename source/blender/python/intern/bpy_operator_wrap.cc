  ...
  /* set the default property: ot->prop */
  {
    ...
    if (bl_property) {
      ...
      if (prop_id != nullptr) {
        ...
        PointerRNA ptr = RNA_pointer_create_isolated(nullptr, ot->srna, nullptr);
...
PyObject *PYOP_wrap_macro_define(PyObject * /*self*/, PyObject *args)
{
  ...
  PointerRNA ptr_otmacro = RNA_pointer_create_isolated(nullptr, &RNA_OperatorMacro, otmacro);
