                              ...
                              float alpha)
{
  ...
  GPU_vertformat_attr_add(&format, "color", VertAttrType::F32, 4, GPU_FETCH_FLOAT);
...
void ui_draw_but_COLORBAND(uiBut *but, const uiWidgetColors *wcol, const rcti *rect)
{
  ...
  pos_id = GPU_vertformat_attr_add(format, "pos", VertAttrType::F32, 2, GPU_FETCH_FLOAT);
  col_id = GPU_vertformat_attr_add(format, "color", VertAttrType::F32, 4, GPU_FETCH_FLOAT);
  immBindBuiltinProgram(GPU_SHADER_3D_SMOOTH_COLOR);
...
void ui_draw_but_CURVE(ARegion *region, uiBut *but, const uiWidgetColors *wcol, const rcti *rect)
{
  ...
  const uint col = GPU_vertformat_attr_add(format, "color", VertAttrType::F32, 4, GPU_FETCH_FLOAT);
  const uint size = GPU_vertformat_attr_add(format, "size", VertAttrType::F32, 1, GPU_FETCH_FLOAT);
