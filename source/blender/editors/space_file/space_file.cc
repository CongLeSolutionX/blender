...
static void file_main_region_message_subscribe(const wmRegionMessageSubscribeParams *params)
{
  ...
  /* SpaceFile itself. */
  {
    PointerRNA ptr = RNA_pointer_create_isolated(&screen->id, &RNA_SpaceFileBrowser, sfile);
  ...
  /* FileSelectParams */
  {
    PointerRNA ptr = RNA_pointer_create_isolated(&screen->id, &RNA_FileSelectParams, file_params);
