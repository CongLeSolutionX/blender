...
DefNode(GeometryNode, GEO_NODE_CLOSURE_INPUT, def_geo_closure_input, "CLOSURE_INPUT", ClosureInput, "Closure Input", "")
DefNode(GeometryNode, GEO_NODE_CLOSURE_OUTPUT, def_geo_closure_output, "CLOSURE_OUTPUT", ClosureOutput, "Closure Output", "")
...
DefNode(GeometryNode, GEO_NODE_COMBINE_BUNDLE, rna_def_geo_combine_bundle, "COMBINE_BUNDLE", CombineBundle, "Combine Bundle", "Combine multiple values into one")
...
DefNode(GeometryNode, GEO_NODE_EVALUATE_CLOSURE, def_geo_evaluate_closure, "EVALUATE_CLOSURE", EvaluateClosure, "Evaluate Closure", "Evaluate a closure function")
...
DefNode(GeometryNode, GEO_NODE_SEPARATE_BUNDLE, rna_def_geo_separate_bundle, "SEPARATE_BUNDLE", SeparateBundle, "Separate Bundle", "Unpack a bundle into individual values")
