...
DefNode(GeometryNode, GEO_NODE_BODY_COLLISION_SHAPE, 0, "BODY_COLLISION_SHAPE", BodyCollisionShape, "Body Collision Shape", "Retrieve the geometry for a single body's collision shape")
...
DefNode(GeometryNode, GEO_NODE_INPUT_SHAPE_CENTER_OF_MASS, 0, "SHAPE_CENTER_OF_MASS", InputShapeCenterOfMass, "Center of Mass", "Center of mass of a collision shape")
DefNode(GeometryNode, GEO_NODE_INPUT_SHAPE_INFO, 0, "INPUT_SHAPE_INFO", InputShapeInfo, "Shape Info", "Properties of collision shapes")
DefNode(GeometryNode, GEO_NODE_INPUT_SHAPE_MASS, 0, "SHAPE_MASS", InputShapeMass, "Mass", "Mass and inertia of a collision shape based on density")
...
DefNode(GeometryNode, GEO_NODE_PHYSICS_APPLY_FORCE, 0, "PHYSICS_APPLY_FORCE", PhysicsApplyForce, "Apply Force", "Apply force to rigid bodies")
DefNode(GeometryNode, GEO_NODE_PHYSICS_APPLY_TORQUE, 0, "PHYSICS_APPLY_TORQUE", PhysicsApplyTorque, "Apply Torque", "Apply torque to rigid bodies")
DefNode(GeometryNode, GEO_NODE_PHYSICS_APPLY_IMPULSE, 0, "PHYSICS_APPLY_IMPLULSE", PhysicsApplyImpulse, "Apply Impulse", "Apply impulse to rigid bodies")
DefNode(GeometryNode, GEO_NODE_PHYSICS_APPLY_ANGULAR_IMPULSE, 0, "PHYSICS_APPLY_ANGULAR_IMPUSE", PhysicsApplyAngularImpulse, "Apply Angular Impulse", "Apply angular impulse to rigid bodies")
DefNode(GeometryNode, GEO_NODE_PHYSICS_CONSTRAINTS, 0, "PHYSICS_CONSTRAINTS", PhysicsConstraints, "Physics Constraints", "Generate constraints between physics bodies")
...
DefNode(GeometryNode, GEO_NODE_SET_BODY_MOTION_TYPE, 0, "SET_BODY_MOTION_TYPE", SetBodyMotionType, "Set Motion Type", "Set the motion type of a rigid body")
...
DefNode(GeometryNode, GEO_NODE_SET_RIGID_BODY_MASS, 0, "SET_RIGID_BODY_MASS", SetRigidBodyMass, "Set Rigid Body Mass", "Set center mass of rigid bodies")
DefNode(GeometryNode, GEO_NODE_SET_RIGID_BODY_INERTIA, 0, "SET_RIGID_BODY_INERTIA", SetRigidBodyInertia, "Set Rigid Body Inertia", "Set local moments of inertia of rigid bodies")
DefNode(GeometryNode, GEO_NODE_SET_RIGID_BODY_VELOCITY, 0, "SET_RIGID_BODY_VELOCITY", SetRigidBodyVelocity, "Set Rigid Body Velocity", "Set linear velocity of rigid bodies")
DefNode(GeometryNode, GEO_NODE_SET_RIGID_BODY_ANGULAR_VELOCITY, 0, "SET_RIGID_BODY_ANGULAR_VELOCITY", SetRigidBodyAngularVelocity, "Set Rigid Body Angular Velocity", "Set angular velocity of rigid bodies")
...
DefNode(GeometryNode, GEO_NODE_SET_SHAPE_DENSITY, 0, "SET_SHAPE_DENSITY", SetShapeDensity, "Set Shape Density", "Set the shape density used to compute mass from volume")
...
DefNode(GeometryNode, GEO_NODE_SHAPE_GEOMETRY, 0, "SHAPE_GEOMETRY", ShapeGeometry, "Shape Geometry", "Create instances for non-primitive shapes with internal geometry")
