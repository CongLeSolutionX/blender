...
template<VertAttrType comp_type, GPUVertFetchMode fetch_mode, typename ColorType>
...
{
  vertex_buffer_fetch_mode<VertAttrType::I8, GPU_FETCH_INT_TO_FLOAT_UNIT, char4>(
      char4(100, -127, 127, 0));
}
...
{
  vertex_buffer_fetch_mode<VertAttrType::U8, GPU_FETCH_INT_TO_FLOAT_UNIT, uchar4>(
...
{
  vertex_buffer_fetch_mode<VertAttrType::I16, GPU_FETCH_INT_TO_FLOAT_UNIT, short4>(
...
{
  vertex_buffer_fetch_mode<VertAttrType::U16, GPU_FETCH_INT_TO_FLOAT_UNIT, ushort4>(
...
{
  vertex_buffer_fetch_mode<VertAttrType::I10_10_10_2,
                           GPU_FETCH_INT_TO_FLOAT_UNIT,
                           GPUPackedNormal>(GPUPackedNormal(321, -511, 511, 0));
}
...
{
  vertex_buffer_fetch_mode<VertAttrType::I8, GPU_FETCH_INT_TO_FLOAT, char4>(char4(4, 5, 6, 1));
}
...
{
  vertex_buffer_fetch_mode<VertAttrType::U8, GPU_FETCH_INT_TO_FLOAT, uchar4>(uchar4(4, 5, 6, 1));
}
...
{
  vertex_buffer_fetch_mode<VertAttrType::I16, GPU_FETCH_INT_TO_FLOAT, short4>(short4(4, 5, 6, 1));
}
...
{
  vertex_buffer_fetch_mode<VertAttrType::U16, GPU_FETCH_INT_TO_FLOAT, ushort4>(
      ushort4(4, 5, 6, 1));
}
...
{
  vertex_buffer_fetch_mode<VertAttrType::I32, GPU_FETCH_INT_TO_FLOAT, int4>(int4(4, 5, 6, 1));
}
...
{
  vertex_buffer_fetch_mode<VertAttrType::U32, GPU_FETCH_INT_TO_FLOAT, uint4>(uint4(4, 5, 6, 1));
}
...
{
  vertex_buffer_fetch_mode<VertAttrType::F32, GPU_FETCH_FLOAT, float4>(float4(4, 5, 6, 1));
}
