...
if(WIN32)
  ...
  harvest(external_shaderc shaderc/include shaderc/include "*")
  harvest(external_shaderc shaderc/lib shaderc/lib "*${SHAREDLIBEXT}*")
  harvest(external_shaderc shaderc/lib shaderc/lib "*${LIBEXT}*")
endif()
